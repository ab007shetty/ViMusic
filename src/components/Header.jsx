...
const Header = ({ onSearch, onSidebarToggle }) => {
  ...
  return (
    <header className="p-4 flex items-center bg-gray-800 text-white bg-gradient-to-r from-emerald-400 to-indigo-600 rounded relative z-40">
      <button
      ...
      <div className="flex items-center ml-4 relative">
        {!user ? (
          <button 
            ...
            className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded flex items-center h-12"
          >
